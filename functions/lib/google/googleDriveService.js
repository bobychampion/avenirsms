 ...
 */
async function listFiles(schoolId, folderId, pageSize = 100, pageToken) {
 ...
 * @throws Error - Not yet implemented
 */
async function uploadFile(schoolId, fileName, mimeType, fileContent, parentFolderId) {
 ...
 * @throws Error - Not yet implemented
 */
async function createFolder(schoolId, folderName, parentFolderId) {
 ...
 * @throws Error - Not yet implemented
 */
async function shareResource(schoolId, fileId, emailAddresses, role) {
 ...
 * @throws Error - Not yet implemented
 */
async function deleteResource(schoolId, fileId) {
 ...
 * @throws Error - Not yet implemented
 */
async function getStorageQuota(schoolId) {
