...
describe('googleAuthService', () => {
  ...
  describe('parseState', () => {
    ...
    it('should throw error for invalid base64', () => {
      expect(() => parseState('not-valid-base64!!!')).toThrow('Failed to parse OAuth state');
    });
    
    it('should throw error for invalid JSON', () => {
      const invalidJson = Buffer.from('not json', 'utf-8').toString('base64');
      expect(() => parseState(invalidJson)).toThrow('Failed to parse OAuth state');
    });
    ...
    it('should throw error for missing schoolId', () => {
      ...
      expect(() => parseState(serialized)).toThrow('missing required fields');
    });
  ...
  describe('getAuthorizationUrl', () => {
    ...
    it('should generate a valid OAuth URL', () => {
      ...
      const url = getAuthorizationUrl(schoolId, scopes, redirectUri);
    ...
    it('should throw error if GOOGLE_CLIENT_ID is not set', () => {
      ...
      expect(() => {
        getAuthorizationUrl('school123', ['openid'], 'https://example.com/callback');
    ...
    it('should handle multiple scopes correctly', () => {
      ...
      const url = getAuthorizationUrl('school123', scopes, 'https://example.com/callback');
