...
exports.admissionApproved = admissionApproved;
exports.admissionRejected = admissionRejected;
exports.feeReminder = feeReminder;
exports.staffWelcome = staffWelcome;
exports.parentNotification = parentNotification;
exports.attendanceAlert = attendanceAlert;
exports.schoolSuspended = schoolSuspended;
exports.demoProvisioned = demoProvisioned;
exports.platformInvoice = platformInvoice;
exports.reportCardReady = reportCardReady;
/** Shared branded wrapper */
function layout(schoolName, primaryColor, body) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
...
/** Admission approved */
function admissionApproved(opts) {
...
/** Admission rejected */
function admissionRejected(opts) {
...
function parentNotification(opts) {
...
function platformInvoice(opts) {
    ...
    const color = branding.primaryColor ?? DEFAULT_COLOR;
    const fmt = (n) => `${currencySymbol}${n.toLocaleString('en', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
